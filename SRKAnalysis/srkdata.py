...
def default_srk_settings(runtype="nedm"):
	...
	if runtype == "g2":
		settings = {
			...
			'EPSAbs': 1e-07,
			'EPSRel': 1e-07,
			'B0FieldStrength': -42.52309,
			'B0FieldDirection': '0 0 1',
			'E0FieldStrength': 0.,
			'E0FieldDirection': '0 0 1',
			'BGradFieldStrength': 0.,
#			'BGradFieldDirection': '0 0 1',
			'EGradFieldStrength': 0.,
#			'EGradFieldDirection': '0 0 1',
			'BQuadFieldStrength': -0.81838,
			'BQuadFieldAxis': '0 1 0',
			'BQuadFieldDirection': '1 0 0',
			'EQuadFieldStrength': 0.,
			'EQuadFieldAxis': '0 1 0',
			'EQuadFieldDirection': '1 0 0',
			'BSextFieldStrength': -0.018459,
			'BSextFieldAxis': '0 1 0',
			'BSextFieldDirection': '1 0 0',
			'ESextFieldStrength': 0.,
			'ESextFieldAxis': '0 1 0',
...
def default_file_stats(runtype="nedm"):
